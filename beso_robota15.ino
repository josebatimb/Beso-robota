/*Robotaren Serboak kontrolatzeko programa.
  Serbo Shield-a erabiliaz
  2020ko otsailaren 3an by Mikel San Sebastian eta Joseba Gallego -> modify By UNFERMAI (3.taldea) 2019 ko urtarrilean
...
int j = 90; //eskua
int zilindroa = 11;
int angeluaSerbo2 = 110;
int gehikuntza = 5;
int gehikuntzak = 5;
int gehikuntzaj = 5; // Pausu bakoitzean gehituo=ko diren graduak
  ...
  switch (i) {
    case 1:
      ...
      if ((y >= 0) && (y <= 494)) {
        ...
        angeluaSerbo2 = constrain(angeluaSerbo2, 0, 180);
        setServo(2, angeluaSerbo2);
